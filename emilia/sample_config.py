...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "1796788090:AAG10KauBDCDh7WJQgzq9AvCVWRv-R3eLkg"
    OWNER_ID = "1407016027"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "sherlockholmes291"
